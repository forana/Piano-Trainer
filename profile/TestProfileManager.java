 ...
 * TestProfileManager
 * 
 * This UnitTest contains the functionality testing
 * the capabilities of the ProfileManager class to
 * verify that the class works as expected.
 * 
 * @author groszc
 * 
 */
public class TestProfileManager extends TestCase {
	...
	public void testGetProfileByName() {
		...
		//compare the getProfileByName to a map between the name and the profile
		...
		assertEquals(manager.getProfileByName("Profile 1"),profilestr.get("Profile 1"));
		assertEquals(manager.getProfileByName("Profile 2"),profilestr.get("Profile 2"));
		assertEquals(manager.getProfileByName("Profile 3"),profilestr.get("Profile 3"));
		assertEquals(manager.getProfileByName("Profile 4"),profilestr.get("Profile 4"));
	}
	...
	public void testSerializable() {
		...
		for(int i=0;i<10;i++)
		{
			//System.out.println(manager.getProfiles().get(i).getName() + "    " + profiles.get(i).getName());
